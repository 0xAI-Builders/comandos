...
6. **Razón y riesgo por fila.** `reason` en una línea ("Fable relotto tiene más margen: 65 %, reset en 3d 4h"). `risk`: bajo si solo cambia effort, medio si cambia modelo en el mismo motor, alto si cambia motor o cuenta.

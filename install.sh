...
for f in index.html sw.js manifest.webmanifest icon-192.png icon-512.png term.html session-config.js workspace.js workspace.css reparto.js reparto.css; do
